...
import { getLiveIncidents } from "../services/api";
...
function IncidentMap() {
  ...
  useEffect(() => {
  getLiveIncidents().then(setIncidents).catch(console.error);
  }, []);
      ...
      >
        ...
        {incidents.map((incident) => (
          ...
          <Marker
            ...
            icon={createMarker(incident.max_severity)}
          >
            ...
            <Popup>
              ...
              >
                ...
                >
                  {incident.total_reports} citizen
